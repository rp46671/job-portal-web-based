          ...
          <div class="main-content-container container-fluid px-4">
            ...
            <div class="row">
              ...
              <div class="col-lg-4 col-md-6 col-sm-12 mb-4">
                ...
                <div class="card card-small h-100">
                  <div class="card-header border-bottom">
                    <h6 class="m-0">Your Ranking</h6>
                  </div>
                  <div class="card-body d-flex flex-column">
                      <div class="blog-comments__item d-flex p-3">
                      <div class="blog-comments__avatar mr-3">
                        <img src="<?php echo base_url('assets/assets/images/avatars/1.jpg');?>" alt="User avatar" /> </div>
              ...
              <div class="col-lg-5 col-md-12 col-sm-12 mb-4">
                <div class="card card-small blog-comments">
                  ...
                  <div class="card-body p-0">
                    ...
                    <div class="blog-comments__item d-flex p-3">
                      <div class="blog-comments__avatar mr-3">
                        <img src="<?php echo base_url('assets/assets/images/avatars/2.jpg');?>" alt="User avatar" /> </div>
                      <div class="blog-comments__content">
                        <div class="blog-comments__meta text-muted">
                          <a class="text-secondary" href="#">James Johnson</a> on
                          <a class="text-secondary" href="#">Hello World!</a>
                    ...
                    <div class="blog-comments__item d-flex p-3">
                      <div class="blog-comments__avatar mr-3">
                        <img src="<?php echo base_url('assets/assets/images/avatars/3.jpg');?>" alt="User avatar" /> </div>
                      <div class="blog-comments__content">
                        <div class="blog-comments__meta text-muted">
                          <a class="text-secondary" href="#">James Johnson</a> on
                          <a class="text-secondary" href="#">Hello World!</a>
