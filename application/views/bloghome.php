        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-8 post-list blog-post-list">
                    ...
                    <div class="single-post">
                        <img class="img-fluid" src="<?php echo site_url('assets/images/p2.jpg');?>" alt="">
                        <ul class="tags">
                            <li><a href="#">Art, </a></li>
                            <li><a href="#">Technology, </a></li>
                            <li><a href="#">Fashion</a></li>
                    ...
                    <div class="single-post">
                        <img class="img-fluid" src="<?php echo site_url('assets/images/p3.jpg');?>" alt="">
                        <ul class="tags">
                            <li><a href="#">Art, </a></li>
                            <li><a href="#">Technology, </a></li>
                            <li><a href="#">Fashion</a></li>
                    ...
                    <div class="single-post">
                        <img class="img-fluid" src="<?php echo site_url('assets/images/p4.jpg');?>" alt="">
                        <ul class="tags">
                            <li><a href="#">Art, </a></li>
                            <li><a href="#">Technology, </a></li>
                            <li><a href="#">Fashion</a></li>
                        ...
                        <div class="blog-list ">
                            <div class="single-recent-post d-flex flex-row">
                                <div class="recent-thumb">
                                    <img class="img-fluid" src="<?php echo site_url('assets/images/r1.jpg');?>" alt="">
                                </div>
                            ...
                            <div class="single-recent-post d-flex flex-row">
                                <div class="recent-thumb">
                                    <img class="img-fluid" src="<?php echo site_url('assets/images/r2.jpg');?>" alt="">
                                </div>
                                <div class="recent-details">
                                    <a href="blog-single.html">
                                        <h4>
                            ...
                            <div class="single-recent-post d-flex flex-row">
                                <div class="recent-thumb">
                                    <img class="img-fluid" src="<?php echo site_url('assets/images/r3.jpg');?>" alt="">
                                </div>
                                <div class="recent-details">
                                    <a href="blog-single.html">
                                        <h4>
                            ...
                            <div class="single-recent-post d-flex flex-row">
                                <div class="recent-thumb">
                                    <img class="img-fluid" src="<?php echo site_url('assets/images/r4.jpg');?>" alt="">
                                </div>
                                <div class="recent-details">
                                    <a href="blog-single.html">
                                        <h4>
